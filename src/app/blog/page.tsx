...
export const metadata: Metadata = {
  ...
  description:
    "Articles courts sur la lecture programme, le Quinté, la value et une approche mobile first pour décider vite au PMU.",
};
    ...
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-8 px-4 py-10 md:px-6">
      <header>
        ...
        <h1 className="mt-2 text-3xl font-black tracking-tight text-[var(--pmu-text)] md:text-4xl">
          Turf, décision & discipline
        </h1>
        <p className="mt-3 text-sm leading-7 text-[var(--pmu-text-soft)]">
          Textes orientés SEO, volontairement courts : méthode avant storytelling. Rien de financier ou de promesse
          de gains.
        </p>
      </header>
