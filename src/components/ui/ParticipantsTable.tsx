...
export function ParticipantsTable({
  ...
  const arrivalMap = new Map(officialArrival.map((row) => [row.numPmu, row.position]));
        ...
        <table className="app-table min-w-[980px]">
          <thead>
            <tr>
              ...
              <th>Musique</th>
              <th>Poids</th>
              {courseFinished ? <th>Arrivée</th> : null}
            </tr>
          </thead>
          <tbody>
            ...
            >
              ...
              <div className="mt-3 grid grid-cols-2 gap-2 text-sm">
                <div className="rounded-xl bg-[var(--pmu-bg)] px-3 py-2">
                  ...
                  <p className="mt-1 font-semibold text-[var(--pmu-text)]">{formatSexAge(participant)}</p>
                </div>
                <div className="rounded-xl bg-[var(--pmu-bg)] px-3 py-2">
                ...
                <div className="rounded-xl bg-[var(--pmu-bg)] px-3 py-2">
                  <p className="text-[11px] uppercase tracking-[0.08em] text-[var(--pmu-text-soft)]">Poids</p>
