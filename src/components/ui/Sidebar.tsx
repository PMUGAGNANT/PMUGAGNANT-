    ...
    <aside className="app-surface fixed inset-y-0 left-0 z-40 hidden w-60 border-r border-[var(--pmu-border)] lg:flex">
      <div className="flex h-full w-full flex-col px-5 py-6">
        <Link href="/" className="flex items-center gap-3 rounded-2xl px-2 py-2">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-[rgba(0,255,136,0.14)] bg-[rgba(0,255,136,0.08)] text-lg font-black text-[var(--pmu-primary)]">
            AI
          </div>
            ...
            return (
              <Link
                ...
                className={`group relative flex items-center rounded-2xl px-4 py-3 text-sm font-semibold transition ${
                  active
                    ? "bg-[rgba(0,255,136,0.08)] text-[var(--pmu-primary)]"
                    : "text-[var(--pmu-text-soft)] hover:bg-[#111111] hover:text-white"
                }`}
              >
                <span
        ...
        <div className="mt-auto app-card-muted p-4">
          ...
          <p className="mt-2 text-sm font-semibold text-white">Lecture rapide des meilleures opportunités du jour.</p>
