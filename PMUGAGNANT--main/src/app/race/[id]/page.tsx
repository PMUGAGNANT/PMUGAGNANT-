...
.rp-official{border:1px solid rgba(212,175,55,0.2);border-radius:20px;background:linear-gradient(135deg,#0D1020,#131628);padding:20px}.rp-official-title{color:#D4AF37;font-size:9px;font-weight:700;letter-spacing:3px;text-transform:uppercase}.rp-arrival-list{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:18px;margin-top:16px}.rp-arrival-item{display:grid;justify-items:center;gap:8px;padding:8px;text-align:center}.rp-arrival-head{display:grid;justify-items:center;gap:8px}.rp-arrival-rank,.rp-live-odds{color:var(--blue);font-size:11px;font-weight:700;letter-spacing:.14em;text-transform:uppercase}.rp-arrival-num{display:grid;place-items:center;border-radius:50%;font-family:"Cormorant Garamond",serif;font-weight:700}.rp-arrival-num.gold{width:56px;height:56px;background:#D4AF37;box-shadow:0 0 28px rgba(212,175,55,.45);color:#080A12;font-size:28px}.rp-arrival-num.silver{width:48px;height:48px;background:rgba(192,192,192,.7);color:#080A12;font-size:24px}.rp-arrival-num.bronze{width:44px;height:44px;background:rgba(205,127,50,.7);color:#080A12;font-size:22px}.rp-arrival-horse{font-family:"Cormorant Garamond",serif;font-size:14px;font-weight:700;color:#fff;line-height:1.15}.rp-ai-badge{display:inline-flex;width:max-content;border-radius:20px;border:1px solid rgba(255,255,255,.1);color:rgba(255,255,255,.3);background:rgba(255,255,255,.05);font-size:10px;font-weight:700;letter-spacing:.12em;padding:3px 10px;text-transform:uppercase}.rp-ai-badge.ok{border-color:rgba(0,255,135,.3);color:#00FF87;background:rgba(0,255,135,.12)}.rp-ai-badge.ko{border-color:rgba(255,255,255,.1);color:rgba(255,255,255,.3);background:rgba(255,255,255,.05)}
.rp-card{overflow:hidden}.rp-card-header,.rp-stitle{display:flex;align-items:center;justify-content:space-between;gap:12px;border-bottom:1px solid var(--line);color:var(--gold);font-size:11px;font-weight:700;letter-spacing:.18em;padding:14px 18px;text-transform:uppercase}.rp-sel-body{padding:22px}.rp-bubbles{display:flex;flex-wrap:wrap;gap:18px}.rp-bubble-wrap{display:grid;justify-items:center;align-content:start;gap:8px;width:96px}.rp-bubble{display:grid;place-items:center;border-radius:50%;color:#080A12;font-family:"Cormorant Garamond",serif;font-weight:700}.rp-bubble.r1{width:64px;height:64px;background:linear-gradient(135deg,#F5DA72,#D4AF37);box-shadow:0 0 30px rgba(212,175,55,.45);font-size:32px}.rp-bubble.r2{width:52px;height:52px;background:rgba(212,175,55,.48);color:#fff;font-size:27px}.rp-bubble.r3{width:44px;height:44px;background:rgba(212,175,55,.22);color:rgba(255,255,255,.72);font-size:23px}.rp-bubble-name{max-width:92px;color:#fff;font-size:11px;font-weight:700;line-height:1.25;text-align:center;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
...
export default async function RacePage({ params, searchParams }: RacePageProps) {
  ...
  const top3 = [...rows]
    ...
    .slice(0, 3);
  const selectionNumbers = new Set(top3.map((row) => row.numero));
  ...
  const arrivalBubbleClasses = ["gold", "silver", "bronze"];
  const navItems = [
