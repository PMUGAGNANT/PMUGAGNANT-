...
html[data-theme="cream"] .rp-wrap{--gold:#A9832E;--green:#075E36;--orange:#B77D22;--red:#C4543D;--blue:#075E36;--muted:#536157;--bg:#FAF7EF;--panel:#FFFDF8;--panel2:#F6F0E4;--line:rgba(20,45,29,.14);background:linear-gradient(180deg,#FFFCF6 0%,#FAF7EF 48%,#F4ECDC 100%);color:#172118}
html[data-theme="cream"] .rp-nav{border-bottom-color:rgba(20,45,29,.10);background:rgba(255,253,248,.94)}
html[data-theme="cream"] .rp-links a,html[data-theme="cream"] .rp-sub,html[data-theme="cream"] .rp-mise.none,html[data-theme="cream"] .rp-vstat-label,html[data-theme="cream"] .rp-th,html[data-theme="cream"] .rp-course-meta,html[data-theme="cream"] .rp-plan-lbl{color:#536157}
html[data-theme="cream"] .rp-course-header,html[data-theme="cream"] .rp-card,html[data-theme="cream"] .rp-scard{background:#FFFDF8;box-shadow:0 18px 46px rgba(22,38,26,.08)}
html[data-theme="cream"] .rp-course-header{background:radial-gradient(circle at 84% 16%,rgba(7,94,54,.10),transparent 26%),#FFFDF8}
html[data-theme="cream"] .rp-course-name,html[data-theme="cream"] .rp-horse,html[data-theme="cream"] .rp-vbet-name,html[data-theme="cream"] .rp-plan-val{color:#172118}
html[data-theme="cream"] .rp-table thead{background:#F6F0E4}
html[data-theme="cream"] .rp-num{color:#536157}
html[data-theme="cream"] .rp-pro-link{background:#075E36;color:#FFFDF8}
html[data-theme="cream"] .rp-pro-lock{border-color:rgba(7,94,54,.22);background:rgba(7,94,54,.08)}
html[data-theme="cream"] .rp-pro-lock p{color:#075E36}
